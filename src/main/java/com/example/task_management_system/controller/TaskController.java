...
public class TaskController {
    ...
    public ResponseEntity<ApiResponse> createTask(@RequestBody TaskCreateRequest request, @PathVariable ObjectId userId){
    ...
    public  ResponseEntity<ApiResponse> findTaskById(@PathVariable ObjectId taskId,@PathVariable ObjectId userId){
    ...
    public  ResponseEntity<ApiResponse> getAllTasks(@PathVariable ObjectId userId){
    ...
    @GetMapping("/find/{userid}/status/{status}")
    public  ResponseEntity<ApiResponse> getTaskByStatus(@PathVariable ObjectId userid,  @PathVariable  TaskStatus status){
    ...
    public ResponseEntity<ApiResponse> deleteTask(@PathVariable ObjectId taskId,@PathVariable ObjectId userId){
        taskService.deleteTask(taskId,userId);
        return  new ResponseEntity<>(ApiResponse.success("Tasks Deleted"),HttpStatus.OK);
    }

    @GetMapping("/overdue/{userId}")
    public  ResponseEntity<ApiResponse> getOverDueTasksById(@PathVariable ObjectId userId){
        List<TaskResponse> response=taskService.getOverdueTasks(userId);
        return  new ResponseEntity<>(ApiResponse.success("Tasks Found",response),HttpStatus.FOUND);
    }

    @PatchMapping("/complete/{taskId}/{userId}")
    public  ResponseEntity<ApiResponse> markComplete(@PathVariable ObjectId taskId,@PathVariable ObjectId userId){
